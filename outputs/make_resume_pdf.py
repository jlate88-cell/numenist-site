...
line("Armed executive protection agent and self-taught AI builder. I run "
     ...
     "licensed, veteran-owned Atlanta firm. On downtime between posts over the "
     "last few years I taught myself to code from the terminal and shipped "
     "working systems: a robot running an offline LLM as its brain; an AI "
     "content factory that routes jobs across image, video, and audio models "
     "and auto-publishes to Etsy and Gumroad with no human in the loop; and a "
     "paid numerology product. Seventeen years shooting and editing film gave "
     "me the eye behind the AI video work. Looking for remote work in AI "
...
line("Taught myself software and AI on post between assignments; shipped the "
     "systems below while on full duty", bullet=True)
gap(2)
...
line("Takes a job, routes each step to the right model across multiple image, "
     ...
     "Gumroad, and the pipeline runs unattended.", bullet=True)
